...
#pragma warning disable CA1707
    [TestMethod]
    public void TranslatePoint_SimpleTranslation_ShouldTranslateCorrectly() {
        ...
        Assert.AreEqual(10.0, actual.Coordinates[0], 0.01);
        Assert.AreEqual(10.0, actual.Coordinates[1], 0.01);
    }

    [TestMethod]
    public void TranslatePoint_SimpleTranslationReverseSecondaryYDirectionPositives_ShouldTranslateCorrectly() {
    ...
    [TestMethod]
    public void TranslatePoint_SimpleTranslationReverseSecondaryDirectionPositives_ShouldTranslateCorrectly() {
    ...
    [TestMethod]
    public void TranslatePoint_SimpleTranslationReversedPositiveOfRoot_ShouldTranslateCorrectly() {
